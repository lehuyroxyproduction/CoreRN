    ...
    return (
      ...
      <TouchableWithoutFeedback onPress={() => {
            ...
            <View style={styles.container}>
              ...
              <ImageBackground source={type ==='virtualRace' ? Images.imgVirtualPopupBg : Images.imgStopPopupBg } style={[styles.imageModal, !type ==='virtualRace' ? {   marginLeft: 30, marginRight: 30} : null ]} imageStyle={{ resizeMode: 'contain'}}>
